...
from cs336_basics.module.attention import ScaledDotProductAttention, MultiHeadAttention, MultiHeadAttentionWithRoPE
...
from cs336_basics.module.cross_entropy import CrossEntropy  
from cs336_basics.optimizer.adamw import AdamW
from cs336_basics.scheduler.lr_cosine_schedule import LRCosineSchedule
from cs336_basics.clip_grad.clip_grad import clip_grad
...
def run_linear(
    ...
    print(in_features.shape, weights.shape)

    assert linear.weight.shape == weights.shape
...
def run_swiglu(
    ...
    swiglu.load_state_dict({"linear1.weight": w1_weight, "linear2.weight": w2_weight, "linear3.weight": w3_weight})
...
def run_multihead_self_attention(
    ...
    mha.load_state_dict({"q_proj.weight": q_proj_weight, "k_proj.weight": k_proj_weight, "v_proj.weight": v_proj_weight, "o_proj.weight": o_proj_weight})
...
def run_get_lr_cosine_schedule(
    ...
    """
    return LRCosineSchedule(max_learning_rate, min_learning_rate, warmup_iters, cosine_cycle_iters)(it) 
...
#     run_train_bpe("/Users/xiaoming.wang/Documents/shawn/课程/CS336/Lab/assignment1-basics/tests/fixtures/tinystories_sample.txt", \
#         100, \
#         ["<|endoftext|>"])
